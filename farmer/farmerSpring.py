...
def movKpiResults(vidnum,buildname,filename):
    ...
    sh=wb.sheets['Sheet1']
    sh.range('B2').value=TD
    sh.range('B3').value=vidnum
    sh.range('B5').value=buildname
    sh.range('B11').value=buildname
    sh.range('B17').value=buildname
    
    sh.range('B6').value=TP_1
    sh.range('B7').value=TP_2
    sh.range('B8').value=TP_3
    sh.range('B9').value=TP_4
    sh.range('B10').value=TP_5
    
    sh.range('B12').value=FP_1
    sh.range('B13').value=FP_2
    sh.range('B14').value=FP_3
    sh.range('B15').value=FP_4
    sh.range('B16').value=FP_5

    sh.range('B18').value=AC_1
    sh.range('B19').value=AC_2
    sh.range('B20').value=AC_3
    sh.range('B21').value=AC_4
    sh.range('B22').value=AC_5
